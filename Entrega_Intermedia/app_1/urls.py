...
from app_1.views import new_product, saludo, electro, new_pc, tecno, house, new_house, tools, new_tool, garments, new_garment, fragance, new_fragance, accesories, new_accesories
